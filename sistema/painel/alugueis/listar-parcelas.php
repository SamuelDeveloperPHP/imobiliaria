...
echo <<<HTML
			<tr class="{$classe_linha}">					
				...
				<td>
					...
					<big><a href="#" onclick="arquivoParcela('{$id}', '{$descricao}')" title="Inserir / Ver Arquivos"><i class="fa fa-file-o " style="color:#22146e"></i></a></big>
					...
					<big><a class="{$ocultar_recibo}" href="rel/recibo_conta_class.php?id={$id}" target="_blank" title="Gerar Recibo"><i class="fa fa-file-pdf-o verde " ></i></a></big>
