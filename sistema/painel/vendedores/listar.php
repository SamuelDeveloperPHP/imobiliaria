...
//retirar quebra de texto do obs
		...
		<big><a href="#" onclick="editar('{$id}', '{$nome}', '{$telefone}', '{$doc}', '{$email}', '{$endereco}', '{$corretor}', '{$data_nasc}', '{$obs}', '{$pessoa}', '{$banco}', '{$tipo}', '{$agencia}', '{$conta}', '{$pix}', '{$estado_civil}', '{$nacionalidade}')" title="Editar Dados"><i class="fa fa-edit text-primary"></i></a></big>

		<big><a href="#" onclick="mostrar('{$nome}', '{$telefone}', '{$doc}', '{$email}', '{$endereco}', '{$nome_corretor}', '{$data_nascF}', '{$data_cadF}', '{$obs}', '{$pessoa}', '{$banco}', '{$tipo}', '{$agencia}', '{$conta}', '{$pix}', '{$estado_civil}', '{$nacionalidade}')" title="Ver Dados"><i class="fa fa-info-circle text-secondary"></i></a></big>
...
<script type="text/javascript">
	...
	function editar(id, nome, telefone, doc, email, endereco, corretor, data_nasc, obs, pessoa, banco, tipo, agencia, conta, pix, estado_civil, nacionalidade){
	...
	function mostrar(nome, telefone, doc, email, endereco, corretor, data_nasc, data_cad, obs, pessoa, banco, tipo, agencia, conta, pix, estado_civil, nacionalidade){
