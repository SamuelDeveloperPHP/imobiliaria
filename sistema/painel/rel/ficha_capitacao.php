...
reservando-nos o direito de intermediação em caso de venda, comissão de _____ sobre o valor das transações, ou comissão  de _____ no caso de locação a qual será paga no ato da assinatura do contrato. Os proprietários reservam o direito de promover,
...
Caso esta autorização tenha uma vigência para divulgação e comercialização do imóvel, preencher com a data inicial ___,___,______ e data final ___,___,______ da vigencia.
...
____________________________________________________ <br>
(Assinatura do Proprietário)<br>

<br><br><br>
<small><small><?php echo mb_strtoupper($data_hoje) ?></small></small>
	</div>	
