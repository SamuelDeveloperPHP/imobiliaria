...
<div class="modal fade" id="modalMostrar" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" >
	...
	<!-- Modal Vender -->
	<div class="modal fade" id="modalAlugar" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<h4 class="modal-title" id="tituloModal">Alugar Imóvel - <span id="nome-vender"> </span></h4>
					<button id="btn-fechar-vender" type="button" class="close" data-dismiss="modal" aria-label="Close" style="margin-top: -20px">
						<span aria-hidden="true">&times;</span>
					</button>
				</div>
				<form id="form-vender" method="post">
					<div class="modal-body">
						...
						<div class="col-md-6">						
							<div class="form-group"> 
								...
								<input type="date" class="form-control" name="data_pgto" id="data_pgto" required> 
							</div>						
						</div>
						...
						<div class="col-md-4">						
							<div class="form-group"> 
								...
								<input type="text" class="form-control" name="comissao_imob" id="comissao_imob" required=""> 
							</div>
							...
							<div class="form-group"> 
								...
								<input type="text" class="form-control" name="comissao_corretor" id="comissao_corretor" required=""> 
							</div>	
						...
						<div class="row">
							...
							<div class="form-group"> 
								<label>OBS</label> 
								<input rows="5" maxlength="255" type="text" class="form-control" name="obs" id="obs" style="height:70px"> 
							</div>	
						</div>
						</div>
						...
						<br>
						<small><div align="center" id="mensagem-vender"></div></small>

						<input type="hidden" class="form-control" name="id-vender"  id="id-vender">
			...
			$("#form-vender").submit(function () {
				...
				$.ajax({
					...
					success: function (mensagem) {
						...
						$('#mensagem-vender').removeClass()
						if (mensagem.trim() == "Inserido com Sucesso") {                    
						$('#btn-fechar-vender').click();
						listar();
						
					} else {
						$('#mensagem-vender').addClass('text-danger')
						$('#mensagem-vender').text(mensagem)
					}
